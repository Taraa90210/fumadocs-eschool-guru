...
<div className="grid grid-cols-2 gap-2 py-4">
  <img src="/images/page/47_daftarkelas.jpg" alt="" className="w-full max-w-xs mx-auto" />
  <img src="/images/page/48_subjekelas.jpg" alt="" className="w-full max-w-xs mx-auto" />
</div>
