...
<div className="grid grid-cols-2 gap-2 py-4">
  <img src="/images/page/41_daftararsipujianon.jpg" alt="" className="w-full max-w-xs mx-auto" />
  <img src="/images/page/42_filterarsipujianon.jpg" alt="" className="w-full max-w-xs mx-auto" />
</div>
